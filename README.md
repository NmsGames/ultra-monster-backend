...
```
cd existing_repo
git remote add origin https://gitlab.com/backend-nms-games/ultra-monster.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/-/experiment/new_project_readme_content:1bb69e70b8a661702eafbe5690ee1a25?https://gitlab.com/backend-nms-games/ultra-monster/-/settings/integrations)
